...
$crank_footer_logo = get_theme_mod('crank_footer_logo');
$crank_footer_top_space = function_exists('tpmeta_field') ? tpmeta_field('crank_footer_top_space') : '0';
$crank_copyright_center = $crank_footer_logo ? 'col-lg-4 offset-lg-4 col-md-6 text-right' : 'col-lg-12 text-center';
...
$footer_top_cta_title = get_theme_mod('footer_top_cta_title', __('Get Latest Updated Subscribe to Our
    Newsletter', 'crank'));
$footer_top_cta = get_theme_mod('footer_top_cta', __('do shortcode', 'crank'));
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="tp-footer-subscribe-wrapper-title d-flex align-items-center">
                                    ...
                                    <?php if (!empty($footer_top_cta_title)): ?>
                                        <h3 class="tp-footer-subscribe-title"> <?php echo crank_kses($footer_top_cta_title); ?></h3>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="tp-footer-copyright-inner">
                        <p><?php print crank_copyright_text(); ?></p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
