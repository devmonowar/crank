...
$facebook_url = get_the_author_meta('crank_user_facebook_url');
$twitter_url = get_the_author_meta('crank_user_twitter_url');
$linkedin_url = get_the_author_meta('crank_user_linkedin_url');
$instagram_url = get_the_author_meta('crank_user_instagram_url');
