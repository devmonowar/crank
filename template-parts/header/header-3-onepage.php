...
$crank_menu_col = $crank_header_right ? 'col-xxl-6 col-xl-6 col-lg-8 d-none d-lg-block' : 'col-xxl-9 col-xl-9 col-lg-8 d-none d-lg-block text-end';
$header_search_switch = get_theme_mod('header_search_switch', false);

//Phone
$header_top_phone = get_theme_mod('header_phone', __('+880190678956', 'crank'));
$header_top_time = get_theme_mod('header_top_time', __('Sunday - Friday: 9 am - 8 pm', 'crank'));
$header_top_menu = get_theme_mod('header_top_menu', __('top menu', 'crank'));
                            ...
                            <div class="tp-header-top-info-3">
                                <ul>
                                    ...
                                    <?php if (!empty($header_top_time)): ?>
                                        <li>
                                            <a href=""><span><i
                                                        class="fa-solid fa-clock"></i></span><?php echo esc_html__("Sunday - Friday:", "crank") ?><b><?php echo esc_html($header_top_time); ?></b></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                            ...
                            <div class="tp-header-top-right-3 d-flex justify-content-end align-items-center">
                                ...
                                <?php if (!empty($header_top_time)): ?>
                                    <div class="tp-header-top-support d-xxl-flex d-none">
                                        <?php echo crank_kses($header_top_menu); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
