...
// info
$crank_topbar_switch = get_theme_mod('header_topbar_switch', false);


// Phone Number
$header_top_phone = get_theme_mod('header_phone', __('+8801310-069824', 'crank'));

// contact button
$crank_button_text = get_theme_mod('crank_button_text', __('Make Request', 'crank'));
$crank_button_link = get_theme_mod('crank_button_link', __('#', 'crank'));

// acc button
$crank_acc_button_text = get_theme_mod('crank_acc_button_text', __('Login', 'crank'));
$crank_acc_button_link = get_theme_mod('crank_acc_button_link', __('#', 'crank'));

$crank_sticky_logo = get_theme_mod('header_sticky_logo', get_template_directory_uri() . '/assets/img/logo/logo-white.png');
// Header Address Text
$header_top_address_text = get_theme_mod('header_address', __('734 H, Bryan Burlington, NC 27215', 'crank'));
$header_address_link = get_theme_mod('header_address_link', __('#', 'crank'));

// Button Text
$header_top_button_switch = get_theme_mod('header_top_button_switch', false);
$header_top_button_text = get_theme_mod('header_button_text', __('Donate Now', 'crank'));

// Button Text
$header_top_button_link = get_theme_mod('header_button_link', __('#', 'crank'));
// header right
$crank_header_right = get_theme_mod('header_right_switch', false);
$crank_menu_col = $crank_header_right ? 'col-xl-7 col-lg-8 d-none d-lg-block' : 'col-xl-10 col-lg-8 d-none d-lg-block';
$crank_menu_end = $crank_header_right ? '' : 'justify-content-end';
// header search btn 
...
<header class="tp-header-area p-relative">
    <div class="tp-header-box p-relative">
        ...
        <div class="tp-header-wrapper-inner header__sticky p-relative">
            <?php if (!empty($crank_topbar_switch)) : ?>
                            ...
                            <?php if (!empty($header_top_phone)): ?>
                                <div class="tp-header-contact-inner d-flex align-items-center">
                                    ...
                                    <div class="tp-header-contact-content">
                                        <p><?php echo esc_html__("Requesting A Call:", "crank") ?></p>
                                        <span><a
