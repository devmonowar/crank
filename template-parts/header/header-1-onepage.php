...
$header_language_switch = get_theme_mod('header_language_switch', __('false', 'crank'));
...
$crank_menu_end = $crank_header_right ? '' : 'd-flex justify-content-end';
                                ...
                                <?php if (!empty($header_top_phone)): ?>
                                    <div class="tp-header-contact-inner d-none d-xl-flex align-items-center">
                                        ...
                                        <div class="tp-header-contact-content">
                                            ...
                                            <span><a href="tel:<?php echo crank_kses($phone_number_url); ?>"><?php echo esc_html($header_top_phone); ?></a></span>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
