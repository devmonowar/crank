...
$social_shear_col = isset($crank_singleblog_social) ? "col-lg-7 col-md-7" : "col-xl-12 col-md-12 col-lg-12";
if (is_single()) : ?>
...
<?php else: ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox__item format-image mb-30 transition-3 format-search'); ?>>
        <?php if (has_post_thumbnail()) : ?>
